...
function LoginPage() {
    ...
    async function handleLogin(e) {
        e.preventDefault();
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/auth/signin", {
                method: "POST",
                body: JSON.stringify({
                    email,
                    password
...
//# sourceMappingURL=frontend_b0b3102a._.js.map