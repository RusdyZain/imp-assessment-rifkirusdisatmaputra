...
export default function PostsPage() {
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {posts.map((post) => (
                <div
                  ...
                  className="card bg-base-100 shadow-md border border-base-300 p-5 text-left transition-all hover:shadow-lg hover:-translate-y-1 cursor-pointer"
                >
                  {post.imageUrl && (
                    <img
      ...
      {selectedId && (
        <PostCard id={selectedId} onClose={() => setSelectedId(null)} />
      )}
    </>
  );
}
